...
// "Toaster" refers to a component that displays non-modal notifications or messages to the user. 
...
// handling signout cleaning state and setting as null
const handleLogout = () => {
    signOut(auth)
        .then(() => {
            user.setAsUser(null)
...
{/* end of if user is logged in:not */}
